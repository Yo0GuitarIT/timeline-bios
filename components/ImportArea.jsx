...
function ImportArea({
  ...
  return (
    <div className="flex gap-1 content-center">
      <div className={isUpload ? "uploadButtonHidden" : "uploadButtonVisible"}>
        <div
          className="relative track-drop box-border border-2 border-dashed border-yellow-400 rounded-lg text-center  hover:text-red-400 bg-opacity-10 bg-black"
